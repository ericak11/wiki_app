# WDI Wiki App #
## GA  August 2014, Project 1 - Version 2


WDI Wiki is a Wiki app for compiling information about WDI. This app can have many users that can update and manage articles. Features include the ability to tag articles as well as become contributors to other participants articles.
